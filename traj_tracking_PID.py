...
if __name__ == '__main__':
    ...
    # Set goal position (puff position from obstacle_positions)
    ...
    planner = PathPlanner(
        ...
        max_iterations=5000,
        robot_radius=0.3,  # Default circular approximation
    ...
    spec, _ = generate_scene_square(init_pos, n_rollers=8)
